...
import { AppModule } from './modules/decorators/etcd-store/app.module';
import { CACHEABLE, Cache } from '../../src';
import { TestService } from './modules/decorators/etcd-store/test/test.service';

describe('Decorator For Etcd Store', () => {
  let server: Server;
