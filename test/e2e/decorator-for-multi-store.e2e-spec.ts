...
import { AppModule } from './modules/decorators/multi-store/app.module';
import { CACHEABLE, Cache } from '../../src';
import { TestService } from './modules/decorators/multi-store/test/test.service';

describe('Decorator For Multi Store', () => {
  let server: Server;
